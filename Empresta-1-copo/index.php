            ...
            <div class="" >
                ...
                <div class="container-fluid"  style="margin:0;padding:0;" >
                   <?php
                    ...
                    $cunsulta_dados_usuario = $pdo->prepare('SELECT * FROM Usuario WHERE Id_Usuario = :key');
                    ...
                    foreach($cunsulta_dados_usuario_ as $item){
                        ...
                        $key_user = md5($id);
                        $consulta_pedidos_usuario = $pdo->prepare('SELECT * FROM `Pedido` WHERE  Voucher_pedido = :key_pedido');
                        $consulta_pedidos_usuario ->execute(array(':key_pedido'=>$key_user));
                        ...
                        if($length <= 0){
                            echo '<div class="alert alert-success  col-md-8" style="top:10px;"  role="document"><center>Olá '.$nome_usuario.', você não possui emprestimos!</center></div><br> ';
                        }else{
                            if($length == 1){
                                echo '<div class="alert alert-success  col-md-8" style="top:10px;"  role="document"><center>Olá '.$nome_usuario.', você possui '.$length.' emprestimo!</center></div><br> ';
                            }else{
                                if($length > 1){
                                    echo '<div class="alert alert-success  col-md-8" style="top:10px;"  role="document"><center>Olá '.$nome_usuario.', você possui '.$length.' emprestimos!</center></div><br> ';
                                }
                            }
