...
<body id="page-top">
   ...
   <nav class="navbar navbar-expand navbar-dark static-top shadow-lg " id="barra-de-navegacao"
    ...
    <div id="wrapper">
        ...
        <!-- Modal devolver -->
        <div class="modal fade" id="modalDevolver" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title fa fa-qrcode" id="exampleModalLabel">&nbsp;&nbsp;Aproxime o QR Code.</h5>
              ...
              <div class="modal-body">
                 <video id="preview_dois" class="col-md-6"></video>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
...
<div class="container-fluid" style="float:right;width:100% !important;">
     
    <div class="container-fluid">
        <div class="card  mx-auto mt-5">
            <div class="card-header" style="background-color:#008B8B;color:white;">Emprestar</div>
            <div class="card-body">
                ...
                <form action="auth.php" method="POST" id="auth">
                    ...
                    <button type="button" class="btn btn-warning" onclick="emprestar()" data-toggle="modal" data-target="#modalExemplo">
                      Validar emprestimo
                    </button>
                </form>
      ...
      <div class="container-fluid ">
         <div class="card  mx-auto mt-5 ">
            <div class="card-header" style="background-color:#008B8B;color:white;">Devolver</div>
            <div class="card-body">
                <form action="encerrar_emprestimo.php" method="POST" id="encerrarEmprestimo">
                    
                    <div class="form-group">
                        <div class="form-label-group">
                           <div class="input-group mb-3">
                              <input type="hidden" name="keyE" id="keyE">
                              <div class="input-group-prepend">
                                <label class="input-group-text" for="tamanho">Estado copo</label>
                              </div>
                        ...
                        <div class="form-label-group">
                            <div class="input-group mb-3">
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control" id="descricao" name="descricao" placeholder="Em caso de devolução de copos danificados descreva aqui a situação do mesmo." rows="5"></textarea>
                              </div>
                            </div>
                        </div>
                    </div>
                  <!-- Botão para acionar modal -->
                    <button type="button" onclick="devolver()" class="btn btn-warning" data-toggle="modal" data-target="#modalDevolver">
                      Validar devolução
                    </button>
                </form>
            </div>
            ...
            let scanner_dois = new Instascan.Scanner({
                video: document.getElementById('preview_dois')
            });
            
            scanner_dois.addListener('scan', function(content) {
               //alert(content);
               document.getElementById("keyE").value = content;
               document.getElementById("encerrarEmprestimo").submit();
